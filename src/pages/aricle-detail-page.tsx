                        ...
                        <div className="mx-auto w-full max-w-screen-xl px-5 ipad:px-12 pt-14 pb-20 mini:px-16 bg-background text-text bg-white">
                            ...
                            <div className="pt-16">
                                ...
                                <div className="mt-8 font-normal text-lg">
                                    <p className="text-gray-600 font-normal">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Totam, ipsa cum! Quibusdam minus aperiam ab illo dolor alias, doloremque, sint magnam quia excepturi asperiores ea repudiandae? Suscipit autem tempore quisquam!
                                    ...
                                    <p className="text-gray-600 font-normal">Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam earum nostrum cumque! Corporis consequatur eligendi placeat autem voluptatibus quod eum expedita facere minus, nam, quisquam at blanditiis illo id vero!
                                    ...
                                    <p className="mt-4 text-gray-600 font-normal">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Necessitatibus excepturi iste maxime nobis ex odio alias maiores quam iure ducimus, quos, nostrum aliquid minima illum et commodi, aut natus soluta.
                                ...
                                <div className="">
                                    ...
                                    <p className="text-gray-600 text-lg font-normal">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam tempore consequatur mollitia autem perspiciatis quam necessitatibus minima, a aliquam. Provident nisi accusantium voluptatem fugit eum sunt, numquam earum cum voluptatibus!
